...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("textarea", { id: "editor", rows: "40", cols: "50", onChange: this.handleChange }, this.state.result), /*#__PURE__*/
      React.createElement("br", null), /*#__PURE__*/
      React.createElement("div", { id: "preview", dangerouslySetInnerHTML: { __html: marked.parse(this.state.result) } })));
